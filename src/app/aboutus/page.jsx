...
const AboutUs = () => {
  return (
    <>
      <div className="container flex flex-col md:w-10/12 sm:w-11/12 w-full mx-auto md:my-32 sm:my-28 my-24 border p-4 shadow">
        ...
        <p className="border text-justify mt-4 leading-relaxed">
          ...
          साथ साथ किसी भी सरकारी नौकरी के लिए तैयारी कर रहे है इन सब के आलावा आप
          लोग हमारी वेबसाइट के जरिये काफी EXAMS के NOTES, PDF, QUESTION PAPERS
          भी ले पाएंगे वो भी बिलकुल फ्री में, आप लोग हमारे YOUTUBE CHANNEL
          aimforteaching को VISIT कर SUBSCRIBE करेंऔर FREE CLASSES लें.
        </p>
      </div>
    </>
  );
