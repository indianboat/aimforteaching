  ...
  <>
    <div className="border fixed right-0 z-40 lg:bottom-10 md:bottom-0 sm:bottom-0 bottom-0 lg:flex md:flex sm:hidden hidden">
      <div className="flex flex-col gap-4 py-2 px-3 rounded-s-2xl border dark:bg-neutral-800 bg-white">
        <Link aria-label="facebook" className="text-[#3b5998] opacity-50 dark:opacity-75 dark:hover:opacity-100 hover:opacity-100" href={"https://goo.gl/GK5nHo"}><BsFacebook size={26}/></Link>
        ...
        <Link aria-label="telegram" className="text-[#3b5998] opacity-50 dark:opacity-75 dark:hover:opacity-100 hover:opacity-100" href={"https://t.me/joinchat/KUKpShcwvYuTUZ8uBIhkVQ"} target="_blank"><BsTelegram size={26}/></Link>
